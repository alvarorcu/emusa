...
class enadd_form1(forms.ModelForm):
 	...
 	def __init__(self, *args, **kwargs):
	        ...
	        if enindex.objects.last():
	        	self.fields['encorreo'].widget.attrs['value'] = enindex.objects.last().encorreo
	        	self.fields['entelf1'].widget.attrs['value'] = enindex.objects.last().entelf1
	        	self.fields['entelf2'].widget.attrs['value'] = enindex.objects.last().entelf2
	        	self.fields['entelf3'].widget.attrs['value'] = enindex.objects.last().entelf3
	        	self.fields['enmenu1'].widget.attrs['value'] = enindex.objects.last().enmenu1
		        self.fields['enmenu2'].widget.attrs['value'] = enindex.objects.last().enmenu2
		        self.fields['enmenu3'].widget.attrs['value'] = enindex.objects.last().enmenu3
		        self.fields['enmenu4'].widget.attrs['value'] = enindex.objects.last().enmenu4
		        self.fields['enmenu5'].widget.attrs['value'] = enindex.objects.last().enmenu5
		        self.fields['enmenu6'].widget.attrs['value'] = enindex.objects.last().enmenu6
	        	self.fields['entitulo_111'].widget.attrs['value'] = enindex.objects.last().entitulo_111
	        	self.fields['entext_secundario111'].initial = enindex.objects.last().entext_secundario111
	        	self.fields['entitulo_121'].widget.attrs['value'] = enindex.objects.last().entitulo_121
	        	self.fields['entext_secundario121'].initial = enindex.objects.last().entext_secundario121
	        	#self.fields['entitulo_131'].widget.attrs['value'] = enindex.objects.last().entitulo_131
	        	self.fields['ensubtitulo131'].widget.attrs['value'] = enindex.objects.last().ensubtitulo131
	        	self.fields['entext_secundario131'].initial = enindex.objects.last().entext_secundario131
	        	self.fields['ensubtitulo132'].widget.attrs['value'] = enindex.objects.last().ensubtitulo132
	        	self.fields['entext_secundario132'].initial = enindex.objects.last().entext_secundario132
	        	self.fields['entitulo_151'].widget.attrs['value'] = enindex.objects.last().entitulo_151
	        	self.fields['entext_secundario151'].initial = enindex.objects.last().entext_secundario151
	        	self.fields['entext_secundario152'].initial = enindex.objects.last().entext_secundario152
...
class enadd_form2(forms.ModelForm):
	def __init__(self, *args, **kwargs):
	        ...
	        if enemballage.objects.last():
	        	self.fields['entitulo_201'].widget.attrs['value'] = enemballage.objects.last().entitulo_201
	        	self.fields['entext_secundario201'].initial = enemballage.objects.last().entext_secundario201
	        	self.fields['enboton_201'].widget.attrs['value'] = enemballage.objects.last().enboton_201
    			self.fields['enboton_251'].widget.attrs['value'] = enemballage.objects.last().enboton_251
		    	self.fields['enboton_252'].widget.attrs['value'] = enemballage.objects.last().enboton_252
	    		self.fields['enboton_253'].widget.attrs['value'] = enemballage.objects.last().enboton_253
			self.fields['entitulo_211'].widget.attrs['value'] = enemballage.objects.last().entitulo_211
			self.fields['entitulo_212'].widget.attrs['value'] = enemballage.objects.last().entitulo_212
			self.fields['entitulo_213'].widget.attrs['value'] = enemballage.objects.last().entitulo_213
			self.fields['enempaque_220'].widget.attrs['value'] = enemballage.objects.last().enempaque_220
			self.fields['enempaque_221'].widget.attrs['value'] = enemballage.objects.last().enempaque_221
			self.fields['enempaque_222'].widget.attrs['value'] = enemballage.objects.last().enempaque_222
			self.fields['enempaque_223'].widget.attrs['value'] = enemballage.objects.last().enempaque_223
			self.fields['enempaque_224'].widget.attrs['value'] = enemballage.objects.last().enempaque_224
			self.fields['enempaque_225'].widget.attrs['value'] = enemballage.objects.last().enempaque_225
			self.fields['enempaque_226'].widget.attrs['value'] = enemballage.objects.last().enempaque_226
			...
			self.fields['ensubtitulo2502'].initial = enemballage.objects.last().ensubtitulo2502
			self.fields['ensubtitulo2503'].initial = enemballage.objects.last().ensubtitulo2503
			self.fields['ensubtitulo2504'].initial = enemballage.objects.last().ensubtitulo2504
			self.fields['ensubtitulo2505'].initial = enemballage.objects.last().ensubtitulo2505
			self.fields['ensubtitulo2506'].initial = enemballage.objects.last().ensubtitulo2506
			self.fields['ensubtitulo2507'].initial = enemballage.objects.last().ensubtitulo2507
			self.fields['ensubtitulo2508'].initial = enemballage.objects.last().ensubtitulo2508
			self.fields['ensubtitulo2509'].initial = enemballage.objects.last().ensubtitulo2509
			self.fields['ensubtitulo2510'].initial = enemballage.objects.last().ensubtitulo2510
			self.fields['ensubtitulo2511'].initial = enemballage.objects.last().ensubtitulo2511
			self.fields['ensubtitulo2512'].initial = enemballage.objects.last().ensubtitulo2512
			self.fields['ensubtitulo2513'].initial = enemballage.objects.last().ensubtitulo2513
			self.fields['ensubtitulo2514'].initial = enemballage.objects.last().ensubtitulo2514
			self.fields['ensubtitulo2515'].initial = enemballage.objects.last().ensubtitulo2515
			self.fields['entext_secundario201'].initial = enemballage.objects.last().entext_secundario201
			...
			self.fields['entext_secundario2504'].initial = enemballage.objects.last().entext_secundario2504
			self.fields['entext_secundario2505'].initial = enemballage.objects.last().entext_secundario2505
			self.fields['entext_secundario2506'].initial = enemballage.objects.last().entext_secundario2506
			self.fields['entext_secundario2507'].initial = enemballage.objects.last().entext_secundario2507
			self.fields['entext_secundario2508'].initial = enemballage.objects.last().entext_secundario2508
			self.fields['entext_secundario2509'].initial = enemballage.objects.last().entext_secundario2509
			self.fields['entext_secundario2510'].initial = enemballage.objects.last().entext_secundario2510
			self.fields['entext_secundario2511'].initial = enemballage.objects.last().entext_secundario2511
			self.fields['entext_secundario2512'].initial = enemballage.objects.last().entext_secundario2512
			self.fields['entext_secundario2513'].initial = enemballage.objects.last().entext_secundario2513
			self.fields['entext_secundario2514'].initial = enemballage.objects.last().entext_secundario2514
			self.fields['entext_secundario2515'].initial = enemballage.objects.last().entext_secundario2515
...
class enadd_form3(forms.ModelForm):
	def __init__(self, *args, **kwargs):
	        ...
	        if entecnology.objects.last():
		        self.fields['entitulo_301'].widget.attrs['value'] = entecnology.objects.last().entitulo_301
	        	self.fields['entext_secundario301'].initial = entecnology.objects.last().entext_secundario301
	        	self.fields['enboton_301'].widget.attrs['value'] = entecnology.objects.last().enboton_301
	        	self.fields['ensubtitulo311'].initial = entecnology.objects.last().ensubtitulo311
	        	self.fields['entext_secundario311'].initial = entecnology.objects.last().entext_secundario311
	        	self.fields['entext_secundario312'].initial = entecnology.objects.last().entext_secundario312
	        	self.fields['entext_secundario313'].initial = entecnology.objects.last().entext_secundario313
	        	self.fields['entext_secundario314'].initial = entecnology.objects.last().entext_secundario314
	        	self.fields['entext_secundario315'].initial = entecnology.objects.last().entext_secundario315
	        	self.fields['entext_secundario316'].initial = entecnology.objects.last().entext_secundario316
	        	self.fields['entext_secundario317'].initial = entecnology.objects.last().entext_secundario317
	        	self.fields['entext_secundario318'].initial = entecnology.objects.last().entext_secundario318
	        	self.fields['entext_secundario319'].initial = entecnology.objects.last().entext_secundario319
	        	self.fields['entitulo_321'].widget.attrs['value'] = entecnology.objects.last().entitulo_321
	        	self.fields['entext_secundario321'].initial = entecnology.objects.last().entext_secundario321
	...
	class Meta:
		...
		'enimagen313' : forms.ClearableFileInput(attrs = {'class' : 'form-control',}),
...
class enadd_form5(forms.ModelForm):
	def __init__(self, *args, **kwargs):
	        ...
	        if encontact.objects.last():
		        self.fields['entitulo_501'].widget.attrs['value'] = encontact.objects.last().entitulo_501
		        ...
		        self.fields['enboton_501'].widget.attrs['value'] = encontact.objects.last().enboton_501
...
class enadd_form6(forms.ModelForm):
	def __init__(self, *args, **kwargs):
	        ...
	        if enfooter.objects.last():
	        	self.fields['entitulo_601'].widget.attrs['value'] = enfooter.objects.last().entitulo_601
	class Meta:
		model = enfooter
		fields = '__all__'
